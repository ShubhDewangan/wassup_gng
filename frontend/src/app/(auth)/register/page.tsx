...
export default function RegisterPage() {
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-[#0A0A0F] flex items-center justify-center px-6 py-12">
        ...
        <CardContent className="space-y-4">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-2">
              <Label htmlFor="name" className="text-xs text-[#8A8A93]">Full Name</Label>
              <div className="relative">
                <User className="pointer-events-none absolute left-4 top-1/2 -translate-y-1/2 h-4 w-4 text-[#8A8A93]" />
                <Input
                  id="name"
                  type="text"
                  required
